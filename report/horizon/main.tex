...
interpretations of root-term topology should be withdrawn pending scope-correct reanalysis.  The
binder-use results reported here use a separate depth-aware traversal and do not inherit that flaw.
